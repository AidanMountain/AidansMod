package net.aidanmountain.aidansmod24.Item.custom;
...
public class HockeyStickItem extends ProjectileWeaponItem{

    public HockeyStickItem(Properties pProperties) {
        super(pProperties);
...
/**
   ...
   public int getDefaultProjectileRange() {
    ...
    //         HockeyPuck proj1 = new HockeyPuck(level, player, look.x, look.y, look.z);
    ...
    //     pTooltipComponents.add(Component.literal("Consumes Puck"));
    ...
    //     throw new UnsupportedOperationException("Unimplemented method 'getAllSupportedProjectiles'");
    // }

    // @Override
    // public int getDefaultProjectileRange() {
    //     // TODO Auto-generated method stub
    //     throw new UnsupportedOperationException("Unimplemented method 'getDefaultProjectileRange'");
    // }
